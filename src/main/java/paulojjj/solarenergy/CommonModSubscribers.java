...
public class CommonModSubscribers {
	...
	public static void subscribeRecipes(FMLLoadCompleteEvent event) {
		...
		RecipeHandler.addEnergyAssemblerRecipe(net.minecraft.world.item.Items.IRON_INGOT, new ItemStack(Items.LEAD_INGOT.getItem(), 1), 100000);
