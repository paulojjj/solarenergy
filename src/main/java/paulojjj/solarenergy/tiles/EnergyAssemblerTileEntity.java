...
public class EnergyAssemblerTileEntity extends EnergyStorageTileEntity implements ITickableTileEntity {
	...
	public void setBlockActive(boolean active) {
		world.setBlockState(pos, Blocks.ENERGY_ASSEMBLER.getItemBlock().getBlock().getDefaultState().with(EnergyAssembler.ACTIVE, active));
	}
